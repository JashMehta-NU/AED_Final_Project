...
public class MainMap extends javax.swing.JFrame {
    ...
    public MainMap() {
        initComponents();
        location = PatientViewNearby.orgLocation;
    ...
    public void init(){        
        ...
        GeoPosition geo = new GeoPosition(Double.parseDouble(locationArray[0]),Double.parseDouble(locationArray[1]));
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        addWaypoint(new MyWaypoint(PatientViewNearby.orgName,event,new GeoPosition(Double.parseDouble(locationArray[0]),Double.parseDouble(locationArray[1]))));
        initWaypoint();
