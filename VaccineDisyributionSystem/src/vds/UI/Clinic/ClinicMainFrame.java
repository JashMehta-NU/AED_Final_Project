 ...
 * @author 17327
 */
public class ClinicMainFrame extends javax.swing.JFrame {
                    ...
                    .addGroup(orderScreenLayout.createSequentialGroup()
                        ...
                        .addGroup(orderScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(orderScreenLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(distributorNameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void storageBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_storageBtnActionPerformed
        ...
        try {
            ...
            pst = sqlConn.prepareStatement("SELECT * from `Clinic` WHERE AdminEmail = ?");
    ...
    private void distributorNameComboItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_distributorNameComboItemStateChanged
        ...
        try {
            ...
            Logger.getLogger(ClinicMainFrame.class
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ClinicMainFrame cm = new ClinicMainFrame();
        mf.setVisible(true);
        cm.setVisible(false);
        super.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClinicMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClinicMainFrame().setVisible(true);
            }
        });
    }
