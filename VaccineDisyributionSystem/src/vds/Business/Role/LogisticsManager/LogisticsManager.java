...
public class LogisticsManager extends UserAccount {
    public LogisticsManager(int id, String fname,String lname, String email, String contact, int age, String gender,String city, String state, String country,String dob,String password,String role){
