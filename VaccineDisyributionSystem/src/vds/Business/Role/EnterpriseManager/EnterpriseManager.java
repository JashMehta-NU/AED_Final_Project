...
public class EnterpriseManager extends UserAccount {
    public EnterpriseManager(String fname,String lname, String email, String contact, int age, String city, String state, String country,String password,String gender,String dob,String role){
        super(fname,lname,email,contact,age,city,state,country,password,gender,dob,role);
    }
    public void addToDatabase(){
        super.addToDB();
    }
     public EnterpriseManager (String email, String password,String role){
